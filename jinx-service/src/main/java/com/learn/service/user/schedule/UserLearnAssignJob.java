//package com.learn.service.user.schedule;
//
...
//@Slf4j
//@Component
//public class UserLearnAssignJob {
//
//    @Autowired
...
//                        continue;
//                    }
//                    if (BizConstants.SOURCE_SELF.equals(task.getSource())) {
//                        updateAssignSource(task, detail);
//                    }
...
//    }
//
//    private void updateAssignSource(UserLearningTask task, AssignmentDetail detail) {
//        task.setSource(BizConstants.SOURCE_ASSIGN);
//        task.setAssignTime(detail.getGmtCreate());
//        task.setDeadline(detail.getFinishTime());
